          ...
          <div className="flex justify-between items-center">
            ...
            <Dialog open={showFlightPassPopup} onOpenChange={setShowFlightPassPopup}>
              <DialogContent className="max-w-md">
                <DialogHeader>
                  <DialogTitle className="text-2xl font-bold text-center">Join Our Official Community 🎉</DialogTitle>
            ...
            <div key={item.id} className="card" data-testid={`menu-item-${item.id}`}>
              ...
              <div className="p-6">
                ...
                <div className="flex flex-wrap gap-1.5 mb-4">
                  ...
                  <Badge 
                    className={`text-xs px-2 py-0.5 ${item.item_type === "buds" ? "bg-green-600" : "bg-purple-600"}`}
                ...
                <div className="mt-4">
                  ...
                  >
                    <SelectTrigger className="w-full" data-testid={`variant-select-${item.id}`}>
                      <SelectValue placeholder="Select size & add to inquiry" />
                    </SelectTrigger>
                    <SelectContent>
